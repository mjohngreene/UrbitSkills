...
=/  results=(list [name=@t pass=?])
  ...
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e=event s1=state-0]  (add-event s0 'First' ~2025.1.1 ~2025.1.2 ~ ~)
      &(=(id.e 0) =(next-id.s1 1) =(~(wyt by events.s1) 1))
    'add-event: first event gets id 0'
  ::
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e1=event s1=state-0]  (add-event s0 'First' ~2025.1.1 ~2025.1.2 ~ ~)
      =/  [e2=event s2=state-0]  (add-event s1 'Second' ~2025.2.1 ~2025.2.2 ~ ~)
      &(=(id.e1 0) =(id.e2 1) =(next-id.s2 2) =(~(wyt by events.s2) 2))
    'add-event: sequential IDs'
  ::
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e=event s1=state-0]  (add-event s0 'Original' ~2025.1.1 ~2025.1.2 ~ ~)
      =/  [edited=event s2=state-0]  (edit-event s1 0 'Updated' ~2025.2.1 ~2025.2.2 `'Desc' ~)
      &(=(title.edited 'Updated') =(description.edited `'Desc') =(~(wyt by events.s2) 1))
    'edit-event: updates fields'
  ::
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e=event s1=state-0]  (add-event s0 'ToDelete' ~2025.1.1 ~2025.1.2 ~ ~)
  ...
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e=event s1=state-0]  (add-event s0 'Find Me' ~2025.1.1 ~2025.1.2 ~ ~)
      =/  result  (get-event s1 0)
      &(?=(^ result) =(title.u.result 'Find Me'))
    'get-event: finds existing'
  ::
  :_  ^-  ?
      =(~ (get-event *state-0 99))
    'get-event: returns ~ for missing'
  ::
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e1=event s1=state-0]  (add-event s0 'A' ~2025.1.1 ~2025.1.2 ~ ~)
      =/  [e2=event s2=state-0]  (add-event s1 'B' ~2025.2.1 ~2025.2.2 ~ ~)
      =((lent (list-events s2)) 2)
    'list-events: returns all'
  ::
  :_  ^-  ?
      =((lent (list-events *state-0)) 0)
    'list-events: empty state'
  ::
  :_  ^-  ?
      =/  s0  *state-0
      =/  [e1=event s1=state-0]  (add-event s0 'Jan' ~2025.1.15 ~2025.1.16 ~ ~)
      =/  [e2=event s2=state-0]  (add-event s1 'Feb' ~2025.2.15 ~2025.2.16 ~ ~)
      =/  [e3=event s3=state-0]  (add-event s2 'Mar' ~2025.3.15 ~2025.3.16 ~ ~)
